                      ...
                      <tr>
                        <td>
                          <table class="invoice-items" cellpadding="0" cellspacing="0">
                            ...
                            <tr>  
                              <td>
                                {{$i->product_name}} @if($i->sku != NULL) - {{$i->sku}}  @endif<br/>
                                <small style="color:#9f9f9f">{{$i->attr_items}}</small>
                              </td>
                ...
                <table class="invoice"> 
                  <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding-top:14px; text-align:left;" valign="top">
                        Please note that we will contact you to discuss the shipping fees based on your address. In the meantime, feel free to contact us for any inquiries.
                    </td>
                  </tr>
                </table>
