        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-7 padd60">
                    ...
                    <a href="/"> <img style="margin-bottom:20px;" src="images/logo.png" alt="Kamaplast" width="200">
                    </a>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" aria-expanded="false" data-parent="#accordion"
                                                href="#collapse1"><i class="glyphicon-shopping-cart glyphicon"></i>
                                                &nbsp;Show order summary <i class="glyphicon glyphicon-chevron-down"
                                                    style="font-size: 10px;"></i><i class="glyphicon glyphicon-chevron-up"
                                                    style="font-size: 10px;"></i>
                                                <div class="pull-right" style="color:#333">$ {{ $totals['total'] }}</div>
                                            </a>
                                        </h4>
                                    </div>
                    ...
                    {!! Form::open(['route' => 'save_shipping_address_delivery_path', 'id' => 'save_form', 'class' => 'add-form']) !!}
                    ...
                    <div class="row">
                        ...
                        @else
                            <div class="col-md-12 form-group user-input-wrp">
                                <input type="text" name="email" class="inputText form-control"
                    ...
                    <div class="row">
                        ...
                        @if (Auth::check())
                            <div class="col-md-12 form-group user-input-wrp">
                                <select name="stored_address_id" class="inputText form-control" id="stored_address"
                                    aria-describedby="basic-addon3">
                                    <option value="" disabled selected>Stored Addresses</option>
                                    @foreach ($addresses as $a)
                                        @if ($a->is_billing == 0)
                                            <option value='{{ $a->address_id }}' <?php if ($a->address_id == session('stored_address_id')) {
                                                echo 'selected';
                                            } ?>>{{ $a->city }},
                                                {{ $a->address }}</option>
                                        @endif
                                    @endforeach
                                    <option value='0' <?php if (session('stored_address_id') == null) {
                                        echo 'selected';
                                    } ?>>New Address...</option>
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group user-input-wrp">
                            <input type="text" name="fullname" class="inputText form-control"
                                value="{{ session('fullname') }}" required>
                            <label class="floating-label" for="fullname">Contact name</label>
                        </div>

                        <div class="col-md-6 form-group user-input-wrp">
                            <input type="text" name="company" class="inputText form-control"
                                value="{{ session('company') }}" required>
                            <label class="floating-label" for="company">Institution Name</label>
                        </div>

                        <div class="col-md-12 form-group user-input-wrp">
                            <input type="text" name="address" class="inputText form-control"
                                value="{{ session('address') }}" maxlength="100" required>
                        ...
                        <div class="col-md-4 form-group user-input-wrp">
                            <input type="text" name="city" id="city" value="{{ session('city') }}"
                                class="inputText form-control required show-error-msg" required>
                            <label class="floating-label" for="city">City</label>
                        </div>

                        <div class="col-md-3 form-group user-input-wrp">
                            <input type="text" name="apartment" class="inputText form-control"
                                value="{{ session('apartment') }}" required>
                            <label class="floating-label" for="apartment">Building</label>
                        </div>

                        <div class="col-md-4 form-group user-input-wrp">
                            <input type="text" name="postal_code" value="{{ session('postal_code') }}"
                                class="inputText form-control" required>
                            <label class="floating-label" for="postal_code">Floor</label>
                        </div>

                        <div class="col-md-12 form-group user-input-wrp">
                            <select name="country" id="country" value="{{ session('country') }}"
                                class="inputText form-control" required>
                                <option value="" disabled selected>Country</option>
                                @foreach ($countries as $c)
                                    <option value="{{ $c->country_id }}" @if ($c->country_id == 127) selected @endif>{{ $c->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12 form-group user-input-wrp">
                            <input type="text" name="address_phone" value="{{ session('address_phone') }}"
                                class="inputText form-control" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <h4> <input id="billing_check" type="checkbox" name="billing_flag" value="1"
                                    @if (session('billing_flag')) checked @endif> &nbsp
                                <label class="billing_check_label" for="billing_check">Billing Address </label>
                                <small style="font-size:60%;">(ticked and filled if it’s not the same as shipping
                                    address)</small>
                            </h4>
                        </div>
                    ...
                    <div class="row" id="billing_div" @if (!session('billing_flag')) style="display:none;" @endif>
                        ...
                        <div class="col-md-6 form-group user-input-wrp">
                            <input type="text" name="billing_fullname" class="inputText form-control"
                                value="{{ session('billing_fullname') }}">
                            <label class="floating-label" for="billing_fullname">Contact name</label>
                        </div>

                        <div class="col-md-6 form-group user-input-wrp">
                            <input type="text" name="billing_company" class="inputText form-control"
                                value="{{ session('billing_company') }}">
                            <label class="floating-label" for="billing_company"> Institution Name</label>
                        </div>

                        <div class="col-md-12 form-group user-input-wrp">
                            <input type="text" name="billing_address" class="inputText form-control"
                                value="{{ session('billing_address') }}" maxlength="100">
                            <label class="floating-label" for="billing_address">Address</label>
                        </div>


                        <div class="col-md-5 form-group user-input-wrp">
                            <input type="text" name="billing_city" value="{{ session('billing_city') }}"
                                class="inputText form-control">
                            <label class="floating-label" for="billing_city">City</label>
                        </div>

                        <div class="col-md-3 form-group user-input-wrp">
                            <input type="text" name="billing_apartment" class="inputText form-control"
                                value="{{ session('billing_apartment') }}">
                            <label class="floating-label" for="billing_apartment">Building</label>
                        </div>

                        <div class="col-md-4 form-group user-input-wrp">
                            <input type="text" name="billing_postal_code"
                                value="{{ session('billing_postal_code') }}" class="inputText form-control">
                            <label class="floating-label" for="billing_postal_code">Floor</label>
                        </div>

                        <div class="col-md-12 form-group user-input-wrp">
                            <select name="billing_country" id="billing_country" value="{{ session('billing_country') }}"
                                class="inputText form-control">
                                <option value="" disabled selected>All countries</option>
                                @foreach ($countries as $c)
                                    <option value="{{ $c->country_id }}" <?php if ($c->country_id == session('billing_country')) {
                                        echo 'selected';
                                    } ?>>{{ $c->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-12 form-group user-input-wrp">
                            <input type="text" name="billing_address_phone" value="{{ session('address_phone') }}"
                                class="inputText form-control">
		...
		--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 hidden-xs">
                            ...
                            <a href="{{ route('cart_path') }}" class="hidden-xs">
                                < Return to cart</a>
                                    <button type="submit" class="btn btn-dark checkout pull-right">Save and proceed to
                                        payment</button>

                        </div>

                        <div class="col-xs-12 visible-xs text-center"><br>
                            <button type="submit" class="btn btn-dark checkout mb-10">Save and proceed to
                                payment</button><br>
                            <a href="{{ route('cart_path') }}">
                                < Return to cart</a>
                        </div>
