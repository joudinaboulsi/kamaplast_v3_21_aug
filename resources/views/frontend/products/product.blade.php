    ...
    <div class="container main-container headerOffset">
        ...
        <div class="row transitionfx">
                ...
                <div class="main-image main-image-thumb-list sp-wrap col-lg-12 no-padding style3 sp-non-touch"
                    ...
                    <div class="main-image col-lg-12 no-padding">
                        ...
                        <a href="{{ getenv('S3_URL') }}/products/large/{{ $product[0]->primary_img }}">
                            <img src="{{ getenv('S3_URL') }}/products/{{ $product[0]->primary_img }}" loading="lazy"
                        ...
                        <a href="{{ getenv('S3_URL') }}/products/large/{{ $i->img }}">
                            <img src="{{ getenv('S3_URL') }}/products/{{ $i->img }}" loading="lazy" class="img-responsive" alt="img">
                        </a>
                        @endif
                        @endforeach
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-5">
                ...
                <div>
                    <img style="float:left; width:25px;" src="../images/diameter-icon.png"  loading="lazy" title="Diameter" />
                    <div style="height:23px; margin-left:50px; margin-top:16px;">
                ...
                <div class="details-description contentBox">
                    ...
                    @if($product[0]->product_id ==463)
                    <img src="{{asset('images/Alba Dimensions.png')}}" loading="lazy" alt="" width="380">
                    @endif
                </div>
                ...
                <div class="row contentBox">
                    <div class="col-lg-12">
                        <div class="">
                            @foreach ($attrItems as $item)
                            @if ($attr->attribute_id == $item->attribute_id)
                            <label class="radio_container" style="font-weight:500;" data-toggle="tooltip" data-placement="top" title="{{ $item->item_name }}">
                                <input type="radio" id="attribute_item_{{ $item->attribute_item_id }}"
                        ...
                        <div class="tab-content" id="video" style="margin-top: 10px">
                            ...
                            <div class="tab-pane" id="video">
                              @foreach ($video as $v )
                                    ...
                                    <iframe width="416" height="303" src="{{$v->link}}"
                                       frameborder="0"
